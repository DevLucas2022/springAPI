...
public class LoadDatabase {
    ...
    return args -> {
        ...
        //****************************************************************
        Path path = Paths.get("C:/Users/aluno/Downloads/produto1.jpg");
        ...
        //****************************************************************
        path = Paths.get("C:/Users/aluno/Downloads/produto2.jpg");
        ...
        imagemRepository.save(imagem);
        //****************************************************************
        path = Paths.get("C:/Users/aluno/Downloads/produto3.jpg");
        file= Files.newInputStream(path);
